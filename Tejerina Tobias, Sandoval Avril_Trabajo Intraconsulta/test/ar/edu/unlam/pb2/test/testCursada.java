...
public class testCursada {
	...
	/*
	 * @Test public void queSePuedaCrearUnaUniversidad() { // preparacion String
	 * nombre = ""; ArrayList<Profesor> profesores = new ArrayList<Profesor>();
	 * ArrayList<Alumno> alumnos = new ArrayList<Alumno>(); ArrayList<Materia>
	 * materias = new ArrayList<Materia>(); ArrayList<Comision> comisiones = new
	 * ArrayList<Comision>();
	 * 
	 * // ejecucion Universidad universidad = new Universidad(nombre, profesores,
	 * alumnos, materias, comisiones);
	 * 
	 * // validacion assertNotNull(universidad); }
	 */
	@Test
	public void queSePuedaIngresarTresProfesoresAUnaUniversidad() {
		...
		Profesor profesor2 = new Profesor(nombre, apellido, dni2);
		Profesor profesor3 = new Profesor(nombre, apellido, dni3);
	...
	public void queSePuedaIngresarTresAlumnosAUnaUniversidad() {
		...
		// ejecucion
		Alumno alumno = new Alumno(nombre, apellido, dni, 2004, 12, 9);
		Alumno alumno2 = new Alumno(nombre, apellido, dni2, 2004, 12, 9);
		Alumno alumno3= new Alumno(nombre, apellido, dni3, 2004, 12, 9);
	...
	/*
	 * 
	 * @Test public void queSePuedaLoguearUnAlumno() { // preparacion String nombre
	 * = ""; String apellido = ""; Integer dni = 46564678; // usuario para ingresar
	 * String contrasenia = ""; // LocalDate fechaIngreso;
	 * 
	 * // ejecucion Alumno alumno = new Alumno(nombre, apellido, dni, contrasenia);
	 * ArrayList<Alumno> alumnos = new ArrayList<Alumno>(); alumnos.add(alumno);
	 * 
